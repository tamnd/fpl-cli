...
Most of these come down to network reality or how fpl serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

fpl rate-limits like any public site. fpl already paces
...
Where a surface is gated, fpl reads a cookie or token you supply
...
`fpl`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what fpl actually did
