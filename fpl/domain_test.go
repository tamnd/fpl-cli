...
// HTTP behaviour is covered in fpl_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "fpl://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("fpl", "about")
	if err != nil || got.String() != "fpl://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want fpl://page/about", got.String(), err)
	}
}
